...
export default function OnlineBanking({ setShowIconDrawer, showIconDrawer }) {
  return (
    <div className='overflow-hidden h-[100vh] w-full overflow-y-scroll flex'>
      <div className={`w-[100%]`}>
        ...
        {/* Main Content */}
        <div className={`mt-[120px] lg:mt-[100px] px-[20px] lg:px-[50px] pb-[60px] flex flex-col justify-center gap-[30px] text-white`}>
          <div className='bg-primary rounded-[20px] py-[5%] p-[10px] lg:px-[15%] font-[700] text-[14px] lg:text-[18px] leading-[22px] flex flex-col gap-8'>
            <div className='flex gap-5 items-center'>
              <p className='w-[150px]'>Site URL</p>
              <input type="text" className='bg-base rounded-[10px] p-[5px] lg:p-[15px] text-black outline-none w-full' />
            </div>
            <div className='flex gap-5 items-center'>
              <p className='w-[150px]'>Merchant ID</p>
              <input type="text" className='bg-base rounded-[10px] p-[5px] lg:p-[15px] text-black outline-none w-full' />
            </div>
            <div className='flex gap-5 items-center'>
              <p className='w-[150px]'>Merchant Key</p>
              <input type="text" className='bg-base rounded-[10px] p-[5px] lg:p-[15px] text-black outline-none w-full' />
            </div>
