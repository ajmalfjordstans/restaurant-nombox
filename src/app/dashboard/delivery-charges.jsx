    ...
    <Accordion open={open === id} icon={<Icon id={id} open={open} />} className="mb-2 rounded-lg  overflow-hidden">
      ...
      <AccordionBody className="pt-1 text-base font-normal">
        <Card className='w-full h-full overflow-scroll'>
          <table className='font-[700] font-raleway text-[14px] lg:text-[18px] w-full text-black text-center'>
            <thead className='bg-[#C4C4C4] '>
              <tr className='h-[60px]'>
                <td className='border-[1px] border-[#DDDDDD] py-4 min-w-[100px]'>Postcode</td>
                <td className='border-[1px] border-[#DDDDDD] py-4 min-w-[100px]'>Min Order</td>
                <td className='border-[1px] border-[#DDDDDD] py-4 min-w-[100px]'>Charge</td>
                <td className='border-[1px] border-[#DDDDDD] py-4 min-w-[100px]'>Free Above</td>
                <td className='border-[1px] border-[#DDDDDD] py-4 min-w-[100px]'>Delivery Limit</td>
                <td className='border-[1px] border-[#DDDDDD] py-4 min-w-[100px]'></td>
              </tr>
            </thead>
            <tbody>
...
export default function DeliveryCharges({ setShowFilter, setShowIconDrawer, showIconDrawer }) {
  ...
  return (
    <div className='overflow-hidden h-[100vh] w-full overflow-y-scroll flex'>
      <div className={`w-[100%]`}>
        ...
        {/* Main Content */}
        <div className={`mt-[100px] px-[20px] lg:px-[50px] pb-[60px] flex flex-col gap-[10px] lg:gap-[30px]`}>
