...
export default function SubscriptionPlan({ setShowFilter, setShowIconDrawer, showIconDrawer }) {
  ...
  return (
    <div className='overflow-hidden h-[100vh] w-full overflow-y-scroll flex relative'>
      <div className='w-full'>
        <div className={`flex justify-between fixed top-0 py-[15px] px-[20px] lg:px-[50px] bg-base w-full z-[200] ${showIconDrawer ? "translate-x-[100px]" : ""} lg:translate-x-[0px] transition-all duration-300`}>
        ...
        <div className='mt-[100px] px-[20px] lg:px-[50px] flex flex-col gap-[12px]'>
